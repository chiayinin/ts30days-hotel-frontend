  ...
  <section className="container py-10 lg:py-[120px] lg:px-10 text-neutral-80 space-y-10 lg:space-y-20">
    ...
    <ul className="space-y-6 lg:space-y-12">
      {roomData.map((room, roomIndex) => (
        <li className="rounded-3xl overflow-hidden hover:shadow-xl" key={roomIndex}>
          <Link to={room._id ?? ''} className="lg:flex lg:justify-center lg:items-center h-[541px] lg:h-[457px] lg:max-w-[1296px] group">
            {/* carousel */}
            <Swiper
            ...
            {/* content */}
            <div className="p-4 lg:p-10 space-y-6 lg:space-y-10 bg-neutral-0 w-full h-auto lg:w-[523px] lg:h-full group-hover:bg-primary-80">
              ...
              <div className="py-4 flex justify-between items-center">
                <span className="block text-title lg:h5 text-primary-100 group-hover:text-primary-120">NT$ {room.price}</span>
