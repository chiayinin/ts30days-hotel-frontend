...
const HistoryContent = ({orderUserId, imageUrl, roomName, days, peopleNum, startDate, endDate, price, className}: {orderUserId:string, imageUrl:string, roomName:string, days:number, peopleNum:number, startDate:string, endDate:string, price:number, className?:string}) => {
