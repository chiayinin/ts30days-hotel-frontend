    ...
    <div className=" bg-neutral-0 text-neutral-80 rounded-[20px] p-10 w-[478px] space-y-10 ">
      ...
      <div className="flex gap-4">
        <div className="border border-neutral-100 rounded-lg p-4">
          <label htmlFor="startDateCalendar" className="font-bold block mb-2">
            入住
          </label>
          <Calendar
            ...
            placeholder="請選擇入住日期"
            // inputClassName="shadow-none ring-2 ring-primary-100"
            showButtonBar />
        </div>
        <div className="border border-neutral-100 rounded-lg p-4">
          <label htmlFor="endDateCalendar" className="font-bold block mb-2">
            退房
          </label>
          <Calendar
          id="endDateCalendar"
          ...
          minDate={minEndDate}
          placeholder="請選擇退房日期"
          // inputClassName="focus:shadow-none focus:ring-2 focus:ring-primary-100"
          showButtonBar />
        </div>
      </div>
      <div className="flex justify-between items-center">
        ...
        <InputNumber
          ...
          decrementButtonClassName="p-4 border rounded-full border-primary-40 w-6 h-6"
          incrementButtonClassName="p-4 border rounded-full border-primary-40 w-6 h-6"
